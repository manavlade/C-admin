          ...
          <TableRow key={appointment.id}>
            ...
            <TableCell>
              <div className="flex flex-col">
                <span className="font-medium">{appointment.consultantName}</span>
                <Badge variant={getTypeColor(appointment.consultantType)} className="w-fit mt-1">
                  {appointment.consultantType.charAt(0).toUpperCase() + appointment.consultantType.slice(1)}
                </Badge>
              </div>
            </TableCell>
            <TableCell>
